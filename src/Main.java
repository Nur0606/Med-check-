import MED_Check.enums.Gender;
import MED_Check.generic.GenericService;
import MED_Check.genericId.GenericId;
...
import MED_Check.service.impl.DepartamentServiceImpl;
import MED_Check.service.impl.DoctorServiceImpl;
import MED_Check.service.impl.HospitalServiceImpl;
import MED_Check.service.impl.PatientServiceImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        GenericService<Departament> departamentGenericService = new DepartamentServiceImpl();
                    ...
                    while (while2){
                        ...
                        switch (scanner.nextInt()){
                            case 1->{
                                ...
                                System.out.println("Enter hospital id: ");
                                Long id = scanner.nextLong();
                                departament.setId(GenericId.genericDepartamentId());
                                System.out.println("Enter department name: ");
                                String name = scanner.next();
                                departament.setDepartmentName(name);
                                System.out.println(departamentGenericService.add(id, departament));
                            }
                            case 2->{
                                System.out.println("Enter hospital id: ");
                                Long id = scanner.nextLong();
                            ...
                            case 3->{
                                ...
                                String  name = scanner.next();
                                departament.setDepartmentName(name);
                                System.out.println(departamentGenericService.updateById( did, departament));
                            }
                            case 4->{
                                System.out.println("Enter hospital id: ");
                                Long id = scanner.nextLong();
                                System.out.println(departamentService.getAllDepartmentByHospital(id));
                            }
                            case 5->{
                                System.out.println("Enter department name: ");
                                String name  = scanner.next();
                                System.out.println(departamentService.findDepartmentByName(name));
                            }
                            case 6-> while2= false;
